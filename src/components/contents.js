export let cards = [{
   ...
   {
      text: "misaki tobisawa enthusiast"
   },
   {
...
export let socialLinks = [{
   ...
   {
      url: 'https://twitter.com/screepaii',
      icon: '#icon-910',
      label: 'Twitter'
   },
   {
